...
class ProductRunningOut extends StatelessWidget {
  const ProductRunningOut({super.key});
      ...
      builder: (context, state) {
        switch (state) {
          ...
          case ProductLoadedState():
            final List<ProductModel> filteredData = state.allProducts
                .where((product) => product.quantity <= 4)
                .toList();
